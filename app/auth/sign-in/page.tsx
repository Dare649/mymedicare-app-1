    ...
    <section className="w-full h-screen flex">
      ...
      <div className="sm:w-full lg:w-[40%] h-screen flex items-center justify-center">
        <div className="w-full max-w-md flex flex-col items-center justify-center p-3">
          ...
          <p className='first-letter:capitalize text-secondary-5 mt-5 text-center'>don't have an account? <span className='text-primary-5 capitalize font-bold cursor-pointer' onClick={() => router.push('/auth/sign-up')}>sign up</span></p>
        </div>
      </div>
    </section>
  );
