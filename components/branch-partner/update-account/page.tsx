...
import { updateBranchPartner, getBranchPartner } from '@/redux/slice/branch-partner/branch-account/branch-partner-account';
import {
  CountryDropdown,
  RegionDropdown,
...
const UpdatePartnerAccount = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await dispatch(updateBranchPartner(formData));
